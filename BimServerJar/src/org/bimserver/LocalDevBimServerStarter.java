...
public class LocalDevBimServerStarter extends AbstractLocalDevBimServerStarter {
	...
	public static void main(String[] args) {
		...
		new LocalDevBimServerStarter().start(-1, "127.0.0.1", "LocalDev BIMserver (8082)", 8082, 8085, optionsParser.getPluginDirectories(), optionsParser.getHome(), resourceFetcher, Paths.get("../BimServer").resolve("www").toAbsolutePath().toString(), true);
	}
}