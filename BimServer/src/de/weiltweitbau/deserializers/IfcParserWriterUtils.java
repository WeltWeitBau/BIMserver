...
public class IfcParserWriterUtils {
	...
	public static Object convertSimpleValue(PackageMetaData packageMetaData, EStructuralFeature eStructuralFeature, Class<?> instanceClass, String value, long lineNumber)
			throws DeserializeException, ConvertSimpleValueException {
		if (!value.equals("")) {
			if (instanceClass == Integer.class || instanceClass == int.class) {
				...
				throw new ConvertSimpleValueException(DeserializerErrorCode.UNEXPECTED_TYPE, instanceClass.getSimpleName() + " expected, but got \"" + value + "\"");
			} else {
				StringBuilder message = new StringBuilder(255);
				
				message.append("Value [").append(value).append("] not supported for Attribute: ").append(eStructuralFeature.getName())
					.append(". Expected value from Enum: ").append(instanceClass.getSimpleName());
				
				throw new ConvertSimpleValueException(DeserializerErrorCode.UNEXPECTED_TYPE, message.toString());
			}
		}
		return null;
	}
	
	private static Object getDefaultValue(EStructuralFeature eStructuralFeature, Class<?> instanceClass, String value, long lineNumber) throws DeserializeException {
...
//			writeErrorLog();
	...
	public static class ConvertSimpleValueException extends Exception {
		DeserializerErrorCode errorCode;
		
		public ConvertSimpleValueException(DeserializerErrorCode errorCode, String message) {
			super(message);
